...
$department_name    = isset($_POST['department_name'])    ? trim(htmlspecialchars($_POST['department_name']))    : '';
$faculty_name  = isset($_POST['faculty_name'])  ? trim(htmlspecialchars($_POST['faculty_name']))  : '';
...
if (empty($department_name) || empty($faculty_name) ) {
...
$sql = "INSERT INTO department (department_name, faculty_name	) VALUES (?, ?)";
...
$stmt->bind_param("ss", $department_name, $faculty_name	);
